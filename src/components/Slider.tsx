    ...
    <div className="w-full h-screen relative overflow-hidden">
      ...
      <button onClick={nextSlide} className="absolute bottom-2/4 right-2 group">
        <motion.div whileTap={{ scale: 0.4 }}>
          <RightArrow iconClass="w-10 h-10 sm:w-14 sm:h-14 fill-gray-300 group-hover:fill-purple-800 opacity-60 group-hover:opacity-100" />
        </motion.div>
      </button>
      <button
      ...
      >
        <motion.div whileTap={{ scale: 0.4 }}>
          <LeftArrow iconClass="w-10 h-10 sm:w-14 sm:h-14 fill-gray-300 group-hover:fill-purple-800 opacity-60 group-hover:opacity-100" />
        </motion.div>
      </button>
    </div>
  );
